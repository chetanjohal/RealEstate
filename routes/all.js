...
/* GET about pages. */
router.get('/fa17g01/about/Joseph', function(req, res, next) {
	res.render('abouts/aboutJoseph');
});
router.get('/fa17g01/about/Sannuj', function(req, res, next) {
	res.render('abouts/aboutSannuj');
});
router.get('/fa17g01/about/Paul', function(req, res, next) {
	res.render('abouts/aboutPaul');
});
router.get('/fa17g01/about/Steven', function(req, res, next) {
	res.render('abouts/aboutSteven');
});
router.get('/fa17g01/about/Chetan', function(req, res, next) {
	res.render('abouts/aboutChetan');
});
router.get('/fa17g01/about/Danny', function(req, res, next) {
	res.render('abouts/aboutDanny');
});

router.get('/fa17g01/search', function(req, res, next) {
